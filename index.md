...
wp.apiFetch.use( wp.apiFetch.createRootURLMiddleware( "https://github.com/amjadaltnbour/amjadstore/wordpress/index.php?rest_route=/" ) );
wp.apiFetch.nonceMiddleware = wp.apiFetch.createNonceMiddleware( "26e83e4862" );
wp.apiFetch.use( wp.apiFetch.nonceMiddleware );
wp.apiFetch.use( wp.apiFetch.mediaUploadMiddleware );
wp.apiFetch.nonceEndpoint = "https://github.com/amjadaltnbour/amjadstore/wordpress/wp-admin/admin-ajax.php?action=rest-nonce";
</script>
...
<script type='text/javascript' src='https://github.com/amjadaltnbour/amjadstore/wordpress/wp-content/plugins/woocommerce/assets/js/frontend/add-to-cart-variation.js?ver=5.2.2' id='wc-add-to-cart-variation-js'></script>
